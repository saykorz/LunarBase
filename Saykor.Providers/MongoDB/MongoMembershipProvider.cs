...
namespace Saykor.Providers.MongoDB
{
    public class MongoMembershipProvider : MembershipProvider
    {
        ...
        public override void UpdateUser(MembershipUser user)
        {
            ...
            var update = Update.Set("ApplicationName", this.ApplicationName)
                .Set("Comment", user.Comment == null ? string.Empty : user.Comment)
        ...
        public override bool ValidateUser(string username, string password)
        {
            ...
            if (username.IsEmail())
            {
                query = Query.And(Query.EQ("ApplicationName", this.ApplicationName), Query.EQ("Email", username));
            }
            else
            {
                query = Query.And(Query.EQ("ApplicationName", this.ApplicationName), Query.EQ("Username", username));
            }
